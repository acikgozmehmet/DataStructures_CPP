...
public:
    Tester()
    {
        AddTest(TestListItem("Push()",            bind(&Tester::Test_Push, this)));
...
int Tester::Test_Push()
{
    ...
    StartTest( "Push one item, the tree size should be 1 and the key should match the item we Pushed" ); {
        BinarySearchTree<string, string> bst;
        // We don't care about the data, just the key.
        bst.Push( "cow", "..." );
    ...
    /* ------------------------------------------------------------------- Pushing B-A-C -- */
    StartTest( "Push B-A-C and validate that the root exists" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "B", "bbb" );
        bst.Push( "A", "aaa" );
        bst.Push( "C", "ccc" );
    ...
    StartTest( "Push B-A-C and validate that the root is B" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "B", "bbb" );
        bst.Push( "A", "aaa" );
        bst.Push( "C", "ccc" );
    ...
    StartTest( "Push B-A-C and validate that the root's left child is A" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "B", "bbb" );
        bst.Push( "A", "aaa" );
        bst.Push( "C", "ccc" );
    ...
    StartTest( "Push B-A-C and validate that the root's right child is C" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "B", "bbb" );
        bst.Push( "A", "aaa" );
        bst.Push( "C", "ccc" );
    ...
    StartTest( "Push B-A-C and validate that the size is 3" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "B", "bbb" );
        bst.Push( "A", "aaa" );
        bst.Push( "C", "ccc" );
    ...
    /* ------------------------------------------------------------------- Pushing A-B-C -- */
    StartTest( "Push A-B-C and validate that the root exists" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "A", "bbb" );
        bst.Push( "B", "aaa" );
        bst.Push( "C", "ccc" );
    ...
    StartTest( "Push A-B-C and validate that the root is A" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "A", "aaa" );
        bst.Push( "B", "bbb" );
        bst.Push( "C", "ccc" );
    ...
    StartTest( "Push A-B-C and validate that the root has NO left child" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "A", "aaa" );
        bst.Push( "B", "bbb" );
        bst.Push( "C", "ccc" );
    ...
    StartTest( "Push A-B-C and validate that the root's right child is B" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "A", "aaa" );
        bst.Push( "B", "bbb" );
        bst.Push( "C", "ccc" );
    ...
    StartTest( "Push A-B-C and validate that the B has NO left child" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "A", "aaa" );
        bst.Push( "B", "bbb" );
        bst.Push( "C", "ccc" );
    ...
    StartTest( "Push A-B-C and validate that the B's right child is C" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "A", "aaa" );
        bst.Push( "B", "bbb" );
        bst.Push( "C", "ccc" );
    ...
    StartTest( "Push A-B-C and validate that the size is 3" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "A", "aaa" );
        bst.Push( "B", "bbb" );
        bst.Push( "C", "ccc" );
...
/* ------------------------------------------------------------------- Pushing C-B-A -- */
    StartTest( "Push C-B-A and validate that the root exists" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "C", "cba" );
        bst.Push( "B", "bac" );
        bst.Push( "A", "abc" );
    ...
    StartTest( "Push C-B-A and validate that the root is C" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "C", "cba" );
        bst.Push( "B", "bac" );
        bst.Push( "A", "abc" );
    ...
    StartTest( "Push C-B-A and validate that the root has NO right child" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "C", "cba" );
        bst.Push( "B", "bac" );
        bst.Push( "A", "abc" );
    ...
    StartTest( "Push C-B-A and validate that the root's left child is B" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "C", "cba" );
        bst.Push( "B", "bac" );
        bst.Push( "A", "abc" );
    ...
    StartTest( "Push C-B-A and validate that the B has NO right child" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "C", "cba" );
        bst.Push( "B", "bac" );
        bst.Push( "A", "abc" );
    ...
    StartTest( "Push C-B-A and validate that the B's left child is A" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "C", "cba" );
        bst.Push( "B", "bac" );
        bst.Push( "A", "abc" );
    ...
    StartTest( "Push C-B-A and validate that the size is 3" ); {
        BinarySearchTree<string, string> bst;
        bst.Push( "C", "cba" );
        bst.Push( "B", "bac" );
        bst.Push( "A", "abc" );
...
{
    StartTestSet( "Test_Delete", { "Push", "Delete" } );
    ostringstream oss;
    bool segfaultRisk = false;

    StartTest( "Push item and make sure root is not null" ); {
    ...
    StartTest( "Push 5-3-7, delete leaf 7, new size is 2" ); {
        BinarySearchTree<int, string> bst;
        bst.Push( 5, "" );
        bst.Push( 3, "" );
        bst.Push( 7, "" );
    ...
    StartTest( "Push 5-3-7, delete leaf 7, now should be null" ); {
        BinarySearchTree<int, string> bst;
        bst.Push( 5, "" );
        bst.Push( 3, "" );
        bst.Push( 7, "" );
